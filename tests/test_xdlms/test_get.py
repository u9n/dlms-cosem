...
from dlms_cosem.protocol.cosem import CosemObject, CosemInterface, Obis
from dlms_cosem.protocol.xdlms import GetResponse, GetRequest
from dlms_cosem.protocol.xdlms.get import GetType, InvokeIdAndPriority
    ...
    def test_to_bytes(self):
        ...
        get_req = GetRequest(
            cosem_attribute=CosemObject(
                interface=CosemInterface.DATA,
                instance=Obis(a=0, b=0, c=43, d=1, e=0, f=255),
                attribute=2,
            ),
            request_type=GetType.NORMAL,
...
class TestGetResponse:
    def test_from_bytes(self):
        ...
        get_response = GetResponse(result=5009, response_type=GetType.NORMAL, invoke_id_and_priority=InvokeIdAndPriority(invoke_id=1, confirmed=True, high_priority=True))
