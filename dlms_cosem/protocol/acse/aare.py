...
class ApplicationAssociationResponseApdu(acse_base.AbstractAcseApdu):
    ...
    PARSE_TAGS = {
        ...
        162: ("result", None),
        163: ("result_source_diagnostics", None),
    ...
    def from_bytes(cls, source_bytes: bytes):
        ...
        while True:
            ...
            object_desc = ApplicationAssociationResponseApdu.PARSE_TAGS.get(object_tag,
                                                                     None)
    ...
    def to_bytes(self) -> bytes:
        ...
        if self.result is not None:
            aare_data.extend(BER.encode(162, self.result))
        if self.result_source_diagnostics is not None:
            aare_data.extend(BER.encode(163, self.result_source_diagnostics))
